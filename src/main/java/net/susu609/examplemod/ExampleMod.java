...
@Mod(ExampleMod.MODID) public class ExampleMod {
    ...
    // Creates a new Block with the id "examplemod:example_block", combining
    ...
    // Creates a new BlockItem with the id "examplemod:example_block",
    ...
    public static final RegistryObject<Item> EXAMPLE_ITEM = ITEMS.register(
            "example_item", () -> new Item(new Item.Properties().food(
                    new FoodProperties.Builder().alwaysEat().nutrition(1)
            ...
            CREATIVE_MODE_TABS.register(
                    "example_tab", () -> CreativeModeTab.builder()
                            ...
                            .displayItems((parameters, output) -> {
                                ...
                                // example item to the tab. For your own
    ...
    public ExampleMod() {
        ...
        // Register the Deferred Register to the mod event bus so tabs get
        // registered
        ...
        // Register our mod's ForgeConfigSpec so that Forge can create and
        // load the config file for us
    ...
    private void commonSetup(final FMLCommonSetupEvent event) {
        ...
        LOGGER.info(
                "DIRT BLOCK >> {}", ForgeRegistries.BLOCKS.getKey(Blocks.DIRT));
        ...
        Config.items.forEach(
                (item) -> LOGGER.info("ITEM >> {}", item.toString()));
    }
